#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════
# SOLAR-NLP — Mechanism Experiment: API Models (Sequential + Auto-Commit)
# ═══════════════════════════════════════════════════════════════════════
#
# Runs mechanism experiments for each API model one at a time.
# After each model finishes ALL 5 domains, results are committed & pushed.
#
# Usage:
#   bash run_mechanism_api.sh              # All API models
#   bash run_mechanism_api.sh 10           # All API models, limit 10
#   bash run_mechanism_api.sh 0 gpt4o     # Single model, no limit
#
# ═══════════════════════════════════════════════════════════════════════
...
echo "═══════════════════════════════════════════════════════════════"
echo "  SOLAR-NLP Mechanism — API Models (Sequential + Auto-Commit)"
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo "  ALL API MECHANISM EXPERIMENTS COMPLETE!"
